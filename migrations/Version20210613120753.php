 ...
 */
final class Version20210613120753 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidature (id INT AUTO_INCREMENT NOT NULL, offre_emploi_id INT NOT NULL, user_id INT NOT NULL, date_creation DATE NOT NULL, etat_candidature TINYINT(1) NOT NULL, rendez_vous_date_time DATETIME DEFAULT NULL, rendez_vous_comment VARCHAR(255) DEFAULT NULL, rendez_vous_enligne TINYINT(1) DEFAULT NULL, rendez_vous_place_link VARCHAR(255) DEFAULT NULL, INDEX IDX_E33BD3B8B08996ED (offre_emploi_id), INDEX IDX_E33BD3B8A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
